...
from first_app.views import product_detail_view,product_create_view, dynamic_lookup_view,product_list_view
...
urlpatterns = [
    ...
    path("product/",product_list_view,name='product_list_view'),
